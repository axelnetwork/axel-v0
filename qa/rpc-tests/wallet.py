...
#   c) node1 mines 32 blocks, so now node 0 has 60001axel_utility_token, node 1 has 4250axel_utility_token, node2 has none.
#   d) node0 sends 601 axel_utility_token to node2, in two transactions (301 axel_utility_token, then 300 axel_utility_token).
