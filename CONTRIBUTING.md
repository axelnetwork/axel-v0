Contributing to AXEL_Utility_Token Core
============================

The AXEL_Utility_Token Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to axel_utility_token-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the axel_utility_token unit tests or QA tests
...
The following applies to code changes to the AXEL_Utility_Token Core project, and is not to be
confused with overall AXEL_Utility_Token Network Protocol consensus changes.

Whether a pull request is merged into AXEL_Utility_Token Core rests with the project merge
...
Patches that change AXEL_Utility_Token consensus rules are considerably more involved than
...
Where a patch set proposes to change the AXEL_Utility_Token consensus, it must have been
...
The project leader is the release manager for each AXEL_Utility_Token Core release.
