...
{
public:
    /// Is the inputs associated with this public key? (and there is deposit AXEL_Utility_Token amount - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of AXEL_Utility_Token.
