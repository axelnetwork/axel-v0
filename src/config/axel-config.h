/* src/config/axel_utility_token-config.h.  Generated from axel_utility_token-config.h.in by configure.  */
/* src/config/axel_utility_token-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AXEL_Utility_Token_CONFIG_H

#define AXEL_Utility_Token_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.axel_utility_token.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AXEL_Utility_Token Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AXEL_Utility_Token Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "axel_utility_token"
...
#endif //AXEL_Utility_Token_CONFIG_H
