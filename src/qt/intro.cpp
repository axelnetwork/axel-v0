...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AXEL_Utility_Token Core"),
     ...
     * override -datadir in the axel_utility_token.conf file in the default data directory
     * (to be consistent with axel_utility_tokend behavior)
     */
    if (dataDir != getDefaultDataDirectory())
