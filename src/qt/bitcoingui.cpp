...
QFontDatabase::addApplicationFont(":/fonts/axel_utility_token_font");

QString windowTitle = tr("AXEL Utility Token Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and AXEL Utility Token: URIs)"));
	...
	toolsAction = new QAction(QIcon(":/icons/tools"), tr("Tools"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AXEL Utility Token Core"), this);
    aboutAction->setStatusTip(tr("Show information about AXEL Utility Token Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AXEL_Utility_Token"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AXEL_Utility_Token addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AXEL_Utility_Token addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the AXEL_Utility_Token Core help message to get a list with possible AXEL_Utility_Token command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AXEL Utility Token Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AXEL_Utility_Token network", "", count));
}
...
{
    QString strTitle = tr("AXEL Utility Token Core"); // default title
    ...
    // Append title to "AXEL_Utility_Token - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
