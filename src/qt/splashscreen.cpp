...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextAXEL_Utility_Token = QChar(0xA9) + QString("  %1  ").arg(COPYRIGHT_YEAR) + QString(tr("The AXEL Utility Token Core developers"));
    ...
    pixPaint.setPen(QColor(144, 19, 254));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextAXEL_Utility_Token);
...
static void InitMessage(SplashScreen* splash, const std::string& message)
{
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        Q_ARG(QColor, QColor(144, 19, 254)));
}
