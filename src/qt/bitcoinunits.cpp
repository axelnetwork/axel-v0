...
// Copyright (c) 2017-2018 The AXEL Core developers
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case AXEL:
            return QString("TestAXELs");
        case mAXEL:
            return QString("Milli-TestAXELs (1 / 1" THIN_SP_UTF8 "000)");
        case uAXEL:
            return QString("Micro-TestAXELs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
