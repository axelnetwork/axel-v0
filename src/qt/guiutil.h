...
/** Utility functions used by the AXEL_Utility_Token Qt UI.
 */
namespace GUIUtil
{
...
// Render AXEL_Utility_Token addresses in monospace font
...
// Parse "axel_utility_token:" URI into recipient object, return true on successful parsing
