...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AXEL_Utility_Token Core axel_utility_token-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  axel_utility_token-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded AXEL_Utility_Token transaction") + "\n" +
                               "  axel_utility_token-tx [options] -create [commands]   " + _("Create hex-encoded AXEL_Utility_Token transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded AXEL_Utility_Token transaction
