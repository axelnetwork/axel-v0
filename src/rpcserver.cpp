...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AXEL_Utility_Token server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AXEL_Utility_Token server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AXEL_Utility_Token features */
        {"axel_utility_token", "masternode", &masternode, true, true, false},
        {"axel_utility_token", "listmasternodes", &listmasternodes, true, true, false},
        {"axel_utility_token", "getmasternodecount", &getmasternodecount, true, true, false},
        {"axel_utility_token", "masternodeconnect", &masternodeconnect, true, true, false},
        {"axel_utility_token", "masternodecurrent", &masternodecurrent, true, true, false},
        {"axel_utility_token", "masternodedebug", &masternodedebug, true, true, false},
        {"axel_utility_token", "startmasternode", &startmasternode, true, true, false},
        {"axel_utility_token", "createmasternodekey", &createmasternodekey, true, true, false},
        {"axel_utility_token", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"axel_utility_token", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"axel_utility_token", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"axel_utility_token", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"axel_utility_token", "getmasternodescores", &getmasternodescores, true, true, false},
        {"axel_utility_token", "mnsync", &mnsync, true, true, false},
        {"axel_utility_token", "spork", &spork, true, true, false},
        {"axel_utility_token", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"axel_utility_token", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use axel_utility_tokend, or the -server option to axel_utility_token-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> axel_utility_token-cli " + methodname + " " + args + "\n";
}
