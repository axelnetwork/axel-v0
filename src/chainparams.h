 ...
 * AXEL_Utility_Token system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& AXEL_Utility_TokenDevKey() const { return vAXEL_Utility_TokenDevKey; }
    // const std::vector<unsigned char>& AXEL_Utility_TokenFundKey() const { return vAXEL_Utility_TokenFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vAXEL_Utility_TokenDevKey;
    // std::vector<unsigned char> vAXEL_Utility_TokenFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
