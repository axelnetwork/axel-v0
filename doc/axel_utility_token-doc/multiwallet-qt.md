...
In order to support loading of multiple wallets in axel_utility_token-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axel_utility_token.cpp.
...
Changes to axel_utility_token.cpp
----------------------
axel_utility_token.cpp is the entry point into axel_utility_token-qt, and as such, will require some minor modifications to provide hooks for
