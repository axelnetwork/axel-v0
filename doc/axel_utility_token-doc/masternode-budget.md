...
AXEL_Utility_Token now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<axel_utility_token_address\> \<monthly_payment_axel_utility_token\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ AXEL_Utility_Token, _12_ times over the course of a year totaling _24000_ AXEL_Utility_Token.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<axel_utility_token_address\> \<monthly_payment_axel_utility_token\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` AXEL_Utility_Token.
 ...
 * vote-many          - Vote on a AXEL_Utility_Token initiative
 * vote-alias         - Vote on a AXEL_Utility_Token initiative
 * vote               - Vote on a AXEL_Utility_Token initiative/budget
